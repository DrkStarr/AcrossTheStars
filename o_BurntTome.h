...
! 02/12/07
  ...
  Movable bookoflydin "burnt tome"
    with  name 'leather' 'book' 'of' 'lydin' 'bible' 'heavy' 'burnt' 'tome',
          description [;
              ...
              "he top page of this tome has been blackened by a scorching fire, edges brittle and
              breaking off. Underneath everything is written in some sort of code using ones and
              zeros, probably binary, filling four chapters that end abruptly.";
          ],
          after [;
              PutOn:
