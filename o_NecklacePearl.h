...
! 08/16/06
  ...
  Movable small_pearl "pearl necklace"
    with  name 'pearl' 'necklace',
          description [;
              if (self in tc_shrine && tc_shrine.fieldon) return PSL();
              PHi();
              "t's a beautifully crafted pearl necklace, probably used for some ceremonial purpose.";
          ],
          describe [;
              if (self.pnhidden) rtrue;
          ],
          after [;
              Insert:
                  if (second == milpack) {
          ...
          before [;
              ...
              PutOn, Use:
                  if (self in player) {
                      ...
                      if (second == pedestal) return PedestalEnds(14);
                      give self ~worn;
                      if (pedestalpos == 1) {
                          switch(pearlcount) {
                              1: if (second == tc_npedestal) {
                                     ...
                                     print "As you put the pearl necklace on ", (the) second,
                      ...
                      if (second == tc_npedestal or tc_spedestal or tc_epedestal or tc_wpedestal) {
                          ...
                          move self to second;
                          print "You put the pearl necklace on ", (the) second, ".^";
                          rtrue;
                      }
                      rfalse;
                  }
