...
! 08/16/06
  ...
  Movable obsidian_stone "obsidian necklace"
    with  name 'obsidian' 'necklace',
          description [;
              if (self in tc_shrine && tc_shrine.fieldon) return PSL();
              PHi();
              "t's a pure black obsidian necklace, probably used for some ceremonial purpose.";
          ],
          after [;
              Insert:
                  if (second == milpack) {
              ...
              Push, PushDir, Pull, Transfer:
                  ...
                  if (self in tc_npedestal or tc_spedestal or tc_epedestal or tc_wpedestal) {
                      if (pedestalpos >= 1) {
                          ...
                          pedestalpos = 0;
                          move self to tranquility_chamber;
                          if (ruby in tc_npedestal or tc_spedestal or tc_epedestal or tc_wpedestal) {
                              ottest = true;
                              move ruby to tranquility_chamber;
                          }
                          if (diamond in tc_npedestal or tc_spedestal or tc_epedestal or tc_wpedestal) {
                              ottest = true;
                              move diamond to tranquility_chamber;
                          }
                          if (small_pearl in tc_npedestal or tc_spedestal or tc_epedestal or tc_wpedestal) {
                              ottest = true;
                              move small_pearl to tranquility_chamber;
                          }
                          print "All the pedestals jump back into their original position as you push ", (the) noun, " to the ground";
                          if (ottest) ", knocking everything to the floor.";
                          ".";
                      }
                  }
              PutOn, Use:
                  if (self in player) {
                      ...
                      if (second == pedestal) return PedestalEnds(13);
                      give self ~worn;
                      if (pedestalpos == 0) {
                          if (second == tc_npedestal or tc_spedestal or tc_epedestal or tc_wpedestal) {
                              if (NecklaceTest()) {
                                  move self to second;
                                  print "You put the obsidian necklace on ", (the) second, ".^";
                                  rtrue;
                              }
                          }
                          switch(stonecount) {
                              1: if (second == tc_npedestal) {
                                     ...
                                     print "As you put the obsidian necklace on ", (the) second,
              ...
              Take:
                  ...
                  if (self in tc_npedestal or tc_spedestal or tc_epedestal or tc_wpedestal) {
                      if (pedestalpos >= 1) {
                          ...
                          print "All the pedestals jump back into their original position as you take ", (the) noun;
                          if (ottest) ", knocking everything to the floor.";
                          ".";
                      }
                  }
