...
[ Abbreviations;
	...
	style fixed;
	print "A -- AFT.  Only aboard ships or space stations.^";
	print "D -- DOWN.^";
	print "E -- EAST.^";
	print "F -- FORE.  Only aboard ships or space stations.^";
	...
	print "NE -- NORTHEAST.^";
	print "NW -- NORTHWEST.^";
	print "P -- PORT.  Only aboard ships or space stations.^";
	print "Q -- QUIT.^";
	print "S -- SOUTH.^";
	print "SB -- STARBOARD.  Only aboard ships or space stations.^";
	print "SE -- SOUTHEAST.^";
	print "SW -- SOUTHWEST.^";
	print "U -- UP.^";
	print "W -- WEST.^";
...
[ OnlineHelp;
	print (ESB) "IF HELP ONLINE^^";
		...
		print "Emily Short's site, http://emshort.wordpress.com/^";
